...
folder are mapped to the application's root namespace, 'CSVDEMO'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CSVDEMO' in the same way
as `"CSVDEMO/sass/src"`.
